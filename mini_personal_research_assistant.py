...
Original file is located at
    https://colab.research.google.com/drive/1OGNz5rvtHRorPjLlFBpJ-KHSFiq5Uwi6
"""

!pip install streamlit arxiv transformers torch

# Save this code to a .py file (we'll run it on Streamlit Cloud later)
code = """
...
with open("research_assistant.py", "w") as file:
    file.write(code)

print("✅ Code saved to research_assistant.py")